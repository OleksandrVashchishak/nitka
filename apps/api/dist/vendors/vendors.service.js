...
const DEMO_VENDORS = [
    {
        ...
        name: 'Студія Світло',
        description: 'Репортажна та художня зйомка весіль. Працюємо спокійно, щоб ви просто насолоджувались днем.',
        categorySlug: 'photo',
        city: 'Київ',
        priceFrom: 28000,
        priceTo: 55000,
    ...
    },
    {
        ...
        name: 'Садиба Олива',
        description: 'Заміська локація з терасою, садом і залом на 120 гостей. Ідеально для теплого вечора.',
        categorySlug: 'venue',
        city: 'Львів',
        priceFrom: 65000,
        priceTo: 120000,
    ...
    },
    {
        ...
        name: 'DJ Horizon',
        description: 'Живий сет під настрій пари. Від тихої церемонії до танцполу до останнього треку.',
        categorySlug: 'music',
        city: 'Одеса',
        priceFrom: 18000,
        priceTo: 35000,
    ...
    },
    {
        ...
        description: 'Квіткові композиції та декор залу. Працюємо з натуральними текстурами і мʼякими відтінками.',
        categorySlug: 'decor',
        city: 'Київ',
        priceFrom: 22000,
        priceTo: 80000,
    ...
    },
    {
        ...
        name: 'Studio Glow',
        description: 'Весільний макіяж і зачіски: натуральний і вечірній образ, пробні виходи, виїзд на локацію.',
        categorySlug: 'beauty',
        city: 'Київ',
        priceFrom: 12000,
        priceTo: 25000,
    ...
    },
    {
        ...
        name: 'Кадр і Тінь',
        description: 'Весільна фотозйомка у Львові: репортаж старим містом, заміські садиби, спокійний таймінг.',
        categorySlug: 'photo',
        city: 'Львів',
        priceFrom: 24000,
        priceTo: 48000,
    ...
    },
    {
        ...
        name: 'Світло моря',
        description: 'Весільні історії біля моря: золота година, відкриті майданчики, легка постановка.',
        categorySlug: 'photo',
        city: 'Одеса',
        priceFrom: 26000,
        priceTo: 52000,
    ...
    },
    {
        ...
        name: 'Плівка Харків',
        description: 'Репортаж і портрети для камерних і великих весіль у Харкові та області.',
        categorySlug: 'photo',
        city: 'Харків',
        priceFrom: 22000,
        priceTo: 45000,
    ...
    },
    {
        ...
        name: 'Terrace Loft',
        description: 'Лофт із терасою в Києві: панорамні вікна, білий зал на 90 гостей, окрема зона церемонії.',
        categorySlug: 'venue',
        city: 'Київ',
        priceFrom: 70000,
        priceTo: 140000,
    ...
    },
    {
        ...
        name: 'Villa Aurora',
        description: 'Садиба біля Одеси з видом і садом. Ідеально для літніх весіль і заходу сонця.',
        categorySlug: 'venue',
        city: 'Одеса',
        priceFrom: 80000,
        priceTo: 150000,
    ...
    },
    {
        ...
        name: 'Riverside Hall',
        description: 'Сучасний зал у Дніпрі біля води: світлий інтерʼєр, сцена, зручна логістика для гостей.',
        categorySlug: 'venue',
        city: 'Дніпро',
        priceFrom: 55000,
        priceTo: 110000,
    ...
    },
    {
        ...
        name: 'Ведучий Марко',
        description: 'Теплий ведучий без кринжу: живий сценарій під вашу пару, таймінг із фото і локацією.',
        categorySlug: 'music',
        city: 'Київ',
        priceFrom: 20000,
        priceTo: 40000,
    ...
    },
    {
        ...
        name: 'Band Evening',
        description: 'Кавер-бенд зі Львова: перший танець, live-блоки й танцпол до останнього треку.',
        categorySlug: 'music',
        city: 'Львів',
        priceFrom: 35000,
        priceTo: 70000,
    ...
    },
    {
        ...
        description: 'Сезонна флористика у Львові: арки, столи, букети з фактурою й без візуального шуму.',
        categorySlug: 'decor',
        city: 'Львів',
        priceFrom: 18000,
        priceTo: 65000,
    ...
    },
    {
        ...
        name: 'Salt & Bloom',
        description: 'Декор для одеських локацій: вітер, світло, легкі тканини й сезонні квіти.',
        categorySlug: 'decor',
        city: 'Одеса',
        priceFrom: 20000,
        priceTo: 75000,
    ...
    },
    {
        ...
        name: 'Atelier Soft',
        description: 'Мʼякий весільний образ у Львові: шкіра, зачіска, стійкість на цілий день.',
        categorySlug: 'beauty',
        city: 'Львів',
        priceFrom: 10000,
        priceTo: 22000,
    ...
    },
    {
        ...
        name: 'Frame DP',
        description: 'Весільний репортаж у Дніпрі: місто, річка, заміські локації. Швидке превʼю.',
        categorySlug: 'photo',
        city: 'Дніпро',
        priceFrom: 20000,
        priceTo: 42000,
    ...
    },
    {
        ...
        name: 'DJ Pulse',
        description: 'DJ для весіль у Харкові: від тихої церемонії до танцполу, своя апаратура.',
        categorySlug: 'music',
        city: 'Харків',
        priceFrom: 15000,
        priceTo: 30000,
...
const DEMO_PROFILE_EXTRAS = {
    'photo.kyiv@demo.local': {
        ...
        availabilityNote: 'Відкрито бронювання на 2027 рік. На осінь 2026 залишилось кілька вільних пʼятниць і неділь.',
    ...
    'venue.lviv@demo.local': {
        ...
        availabilityNote: 'Проводимо події з квітня до жовтня. Суботи літа 2027 уже активно бронюють.',
        services: [
            'Оренда залу',
            'Церемонія в саду',
            'Кейтеринг',
    ...
    'dj.odesa@demo.local': {
        ...
        availabilityNote: 'Працюємо цілий рік. Для літніх субот краще писати щонайменше за 6 місяців.',
        services: [
            'DJ-сет',
            'Звук для церемонії',
            'Світло',
    ...
    'decor.kyiv@demo.local': {
        ...
        availabilityNote: 'Беремо до чотирьох великих проєктів на місяць, щоб не втрачати якість.',
...
let VendorsService = class VendorsService {
            ...
            if (!existing) {
                await this.prisma.vendor.create({
                    data: {
                        userId: user.id,
                        name: demo.name,
                        slug: await this.ensureUniqueSlug((0, slug_1.slugify)(demo.name)),
    ...
    async getFilterOptions() {
        ...
        const cities = [...new Set(vendors.map((v) => v.city))].sort((a, b) => a.localeCompare(b, 'uk'));
        const styles = [
            ...new Set(vendors.flatMap((v) => v.styles)),
        ].sort((a, b) => a.localeCompare(b, 'uk'));
        const maxPrice = vendors.reduce((max, v) => Math.max(max, v.priceFrom), 0);
        return {
            cities,
            styles,
    ...
    async recordView(vendorId, viewer) {
