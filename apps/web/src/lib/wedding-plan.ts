...
export const PLAN_ITEMS: PlanItemMeta[] = [
  ...
  item(
    ...
    [
      ...
      "Підготуй текст і дедлайн запрошення",
  ...
  item(
    ...
    [
      ...
      "Збери в одному місці запрошення та контакти",
    ],
    "Одна точка правди",
  ...
  item(
    ...
    [
      ...
      "Надішли запрошення",
      "Постав зрозумілий дедлайн запрошення",
    ],
    "Надішли завчасно",
  ...
  item(
    ...
    "Заверши збір запрошень на тиждень раніше дедлайну кейтерингу — буде запас на запізнілі відповіді.",
  ),
  item(
    "requests",
    4,
